...
function ViewAtrasoROP02({rop02All,onLegacyFallback}){
  ...
  return(
    <div className="fade-in" style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <Card title={`Saltos de carga por equipo (${saltosPendientes.length})`} action={<BtnExcel onClick={()=>excelFromCols(colsSaltos.filter(c=>c.key!=="accion"),saltosPendientes,"Saltos_ROP02")}/>}>
        <Table cols={colsSaltos} rows={saltosPendientes} maxH={520} emptyMsg="No se detectaron saltos intermedios de carga por equipo con los filtros seleccionados"/>
      </Card>
